...
import EndodonciasAnterior from './Pages/Triaje/Procedimientos/Endodoncias/Anterior/anterior';
import EndodonciasMolar from './Pages/Triaje/Procedimientos/Endodoncias/Molar/molar';
import EndodonciasPreMolar from './Pages/Triaje/Procedimientos/Endodoncias/PreMolar/pre-molar';
  ...
  return (
    ...
    <Router>
            <Routes>
                ...
                <Route path="/triaje/endodoncias/anterior" element={<EndodonciasAnterior />} />
                <Route path="/triaje/endodoncias/molar" element={<EndodonciasMolar />} />
                <Route path="/triaje/endodoncias/pre-molar" element={<EndodonciasPreMolar />} />

                <Route path="/triaje/odontopediatria/control" element={<OdontopediatriaControl />} />
                <Route path="/triaje/odontopediatria/no-operatorio" element={<OdontopediatriaNoOperativo />} />
                <Route path="/triaje/odontopediatria/operatorio" element={<OdontopediatriaOperativo />} />

                <Route path="/triaje/ortodoncia/aparato" element={<OrtodonciaAparato />} />
                <Route path="/triaje/ortodoncia/control" element={<OrtodonciaControl />} />

                <Route path="/triaje/periodoncia/no-quirurgico" element={<PeriodonciaNoQuirurgico />} />
                <Route path="/triaje/periodoncia/quirurgico" element={<PeriodonciaQuirurgico />} />
                <Route path="/triaje/periodoncia/fase-mantenimiento" element={<PeriodonciaFaseMantenimiento />} />

                <Route path="/triaje/protesis/fija" element={<ProtesisFija />} />
                <Route path="/triaje/protesis/removible" element={<ProtesisRemovible />} />
