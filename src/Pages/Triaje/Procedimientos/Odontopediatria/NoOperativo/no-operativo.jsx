  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      ...
      .then((data) => {
        ...
        navigate("/triaje");
        alert(
          `El estudiante fue exitosamente asignado al paciente en Odontopediatría No Operatorio`
        );
      })
  ...
  return (
    <>
      ...
      <div className="PacientesProcedimientos">
        <h1>Pacientes en Odontopediatría No Operatorio</h1>
        <input
          type="text"
          placeholder="Buscar..."
          value={searchQuery}
                  ...
                  <React.Fragment key={index}>
                    ...
                    >
                      ...
                      <td>
                        ...
                        {item.matriculaEstudiante_odontopediatria_no_operatorio
                          .S ||
                        ...
                        item.apellidoEstudiante_odontopediatria_no_operatorio
                          ...
                          <button
                            ...
                            onClick={() =>
                              alert(
                                `El estudiante ${item.nombreEstudiante_odontopediatria_no_operatorio.S} ${item.apellidoEstudiante_odontopediatria_no_operatorio.S} de matrícula ${item.matriculaEstudiante_odontopediatria_no_operatorio.S} ya fue asignado a este paciente previamente`
                              )
                            }
                          >
                            Asignado
