  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      ...
      .then((data) => {
        ...
        navigate("/triaje");
        alert(
          `El estudiante fue exitosamente asignado al paciente en Endodoncia Molar`
        );
      })
                      ...
                      <td>
                        ...
                        item.apellidoEstudiante_endodoncia_molar.S ? (
                          <button
                            ...
                            onClick={() =>
                              alert(
                                `El estudiante ${item.nombreEstudiante_endodoncia_molar.S} ${item.apellidoEstudiante_endodoncia_molar.S} de matrícula ${item.matriculaEstudiante_endodoncia_molar.S} ya fue asignado a este paciente previamente`
                              )
                            }
                          >
                            Asignado
