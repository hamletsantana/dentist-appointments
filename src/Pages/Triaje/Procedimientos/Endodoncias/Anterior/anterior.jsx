...
const Anterior = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      formData.matriculaEstudiante_endodoncia_anterior.trim() === "" ||
      formData.nombreEstudiante_endodoncia_anterior.trim() === "" ||
      formData.apellidoEstudiante_endodoncia_anterior.trim() === ""
    ) {
    ...
    if (
      !nameRegex.test(formData.nombreEstudiante_endodoncia_anterior) ||
      !nameRegex.test(formData.apellidoEstudiante_endodoncia_anterior)
    ) {
    ...
    if (
      !matriculaRegex.test(formData.matriculaEstudiante_endodoncia_anterior)
    ) {
      alert(
    ...
    fetch(
      "https://3lmv2y6pmb.execute-api.us-east-1.amazonaws.com/development/dentist-appointment-update-request",
      {
        ...
        body: JSON.stringify({
          ...formData,
          pageType: "endodoncia_anterior", // Change to appropriate page type based on the page
        }),
      }
    )
      .then((response) => {
      ...
      .then((data) => {
        ...
        navigate("/triaje");
        alert(
          `El estudiante fue exitosamente asignado al paciente en Endodoncia Anterior`
        );
      })
                      ...
                      <td>
                        ...
                        item.apellidoEstudiante_endodoncia_anterior.S ? (
                          <button
                            ...
                            onClick={() =>
                              alert(
                                `El estudiante ${item.nombreEstudiante_endodoncia_anterior.S} ${item.apellidoEstudiante_endodoncia_anterior.S} de matrícula ${item.matriculaEstudiante_endodoncia_anterior.S} ya fue asignado a este paciente previamente`
                              )
                            }
                          >
                            Asignado
                                ...
                                <Col lg="5">
                                  <Form.Group controlId="formMatriculaEstudiante">
                                    ...
                                    <Form.Control
                                      ...
                                      value={
                                        formData.matriculaEstudiante_endodoncia_anterior
                                      }
                                      name="matriculaEstudiante_endodoncia_anterior"
                                ...
                                <Col lg="5">
                                  <Form.Group controlId="formNombreEstudiante">
                                    ...
                                    <Form.Control
                                      ...
                                      value={
                                        formData.nombreEstudiante_endodoncia_anterior
                                      }
                                      name="nombreEstudiante_endodoncia_anterior"
                                      onChange={handleChange}
                                    />
                                  </Form.Group>
                                </Col>
                                ...
                                <Col lg="5">
                                  <Form.Group controlId="formApellidoEstudiante">
                                    ...
                                    <Form.Control
                                      ...
                                      value={
                                        formData.apellidoEstudiante_endodoncia_anterior
                                      }
                                      name="apellidoEstudiante_endodoncia_anterior"
                                      onChange={handleChange}
                                    />
                                  </Form.Group>
                                </Col>
