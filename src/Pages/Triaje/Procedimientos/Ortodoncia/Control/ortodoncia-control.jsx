...
const OrtodonciaControl = () => {
  ...
  const toggleForm = (index) => {
    const item = OrtodonciaControlDataData[index];
  ...
  const handleSubmit = (e) => {
    ...
    if (
      formData.matriculaEstudiante_ortodoncia_control.trim() === "" ||
      formData.nombreEstudiante_ortodoncia_control.trim() === "" ||
      formData.apellidoEstudiante_ortodoncia_control.trim() === ""
    ) {
    ...
    if (
      !nameRegex.test(formData.nombreEstudiante_ortodoncia_control) ||
      !nameRegex.test(formData.apellidoEstudiante_ortodoncia_control)
    ) {
    ...
    if (!matriculaRegex.test(formData.matriculaEstudiante_ortodoncia_control)) {
      alert(
    ...
    fetch(
      "https://3lmv2y6pmb.execute-api.us-east-1.amazonaws.com/development/dentist-appointment-update-request",
      {
        ...
        body: JSON.stringify({
          ...formData,
          pageType: "ortodoncia_control", // Change to appropriate page type based on the page
        }),
      }
    )
      .then((response) => {
      ...
      .then((data) => {
        ...
        navigate("/triaje");
        alert(
          `El estudiante fue exitosamente asignado al paciente en Ortodoncia Control`
        );
      })
                      ...
                      <td>
                        ...
                        item.apellidoEstudiante_ortodoncia_control.S ? (
                          <button
                            ...
                            onClick={() =>
                              alert(
                                `El estudiante ${item.nombreEstudiante_ortodoncia_control.S} ${item.apellidoEstudiante_ortodoncia_control.S} de matrícula ${item.matriculaEstudiante_ortodoncia_control.S} ya fue asignado a este paciente previamente`
                              )
                            }
                          >
                            Asignado
                                ...
                                <Col lg="5">
                                  <Form.Group controlId="formMatriculaEstudiante">
                                    ...
                                    <Form.Control
                                      ...
                                      value={
                                        formData.matriculaEstudiante_ortodoncia_control
                                      }
                                      name="matriculaEstudiante_ortodoncia_control"
                                ...
                                <Col lg="5">
                                  <Form.Group controlId="formNombreEstudiante">
                                    ...
                                    <Form.Control
                                      ...
                                      value={
                                        formData.nombreEstudiante_ortodoncia_control
                                      }
                                      name="nombreEstudiante_ortodoncia_control"
                                      onChange={handleChange}
                                    />
                                  </Form.Group>
                                </Col>
                                ...
                                <Col lg="5">
                                  <Form.Group controlId="formApellidoEstudiante">
                                    ...
                                    <Form.Control
                                      ...
                                      value={
                                        formData.apellidoEstudiante_ortodoncia_control
                                      }
                                      name="apellidoEstudiante_ortodoncia_control"
                                      onChange={handleChange}
                                    />
                                  </Form.Group>
                                </Col>
