  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      ...
      .then((data) => {
        ...
        navigate("/triaje");
        alert(
          `El estudiante fue exitosamente asignado al paciente en Ortodoncia Aparato`
        );
      })
                      ...
                      <td>
                        ...
                        item.apellidoEstudiante_ortodoncia_aparato.S ? (
                          <button
                            ...
                            onClick={() =>
                              alert(
                                `El estudiante ${item.nombreEstudiante_ortodoncia_aparato.S} ${item.apellidoEstudiante_ortodoncia_aparato.S} de matrícula ${item.matriculaEstudiante_ortodoncia_aparato.S} ya fue asignado a este paciente previamente`
                              )
                            }
                          >
                            Asignado
