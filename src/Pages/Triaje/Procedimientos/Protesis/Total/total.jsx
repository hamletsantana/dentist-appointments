  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      ...
      .then((data) => {
        ...
        navigate("/triaje");
        alert(
          `El estudiante fue exitosamente asignado al paciente en Prótesis Total`
        );
      })
                      ...
                      <td>
                        ...
                        item.apellidoEstudiante_protesis_total.S ? (
                          <button
                            ...
                            onClick={() =>
                              alert(
                                `El estudiante ${item.nombreEstudiante_protesis_total.S} ${item.apellidoEstudiante_protesis_total.S} de matrícula ${item.matriculaEstudiante_protesis_total.S} ya fue asignado a este paciente previamente`
                              )
                            }
                          >
                            Asignado
