  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      ...
      .then((data) => {
        ...
        navigate("/triaje");
        alert(`El estudiante fue exitosamente asignado al paciente en Cirugía`);
      })
                        ...
                        <td>
                          ...
                          item.apellidoEstudiante_cirugia.S ? (
                            <button
                              ...
                              onClick={() =>
                                alert(
                                  `El estudiante ${item.nombreEstudiante_cirugia.S} ${item.apellidoEstudiante_cirugia.S} de matrícula ${item.matriculaEstudiante_cirugia.S} ya fue asignado a este paciente previamente`
                                )
                              }
                            >
                              Asignado
                                  ...
                                  <Col lg="5">
                                    <Form.Group controlId="formmatriculaEstudiante_cirugia">
                                      ...
                                      <Form.Control
                                        ...
                                        value={
                                          formData.matriculaEstudiante_cirugia
                                        }
                                  ...
                                  <Col lg="5">
                                    <Form.Group controlId="formnombreEstudiante_cirugia">
                                      ...
                                      <Form.Control
                                        ...
                                        value={
                                          formData.nombreEstudiante_cirugia
                                        }
                                  ...
                                  <Col lg="5">
                                    <Form.Group controlId="formapellidoEstudiante_cirugia">
                                      ...
                                      <Form.Control
                                        ...
                                        value={
                                          formData.apellidoEstudiante_cirugia
                                        }
