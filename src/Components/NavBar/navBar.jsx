            ...
            <ul className="nav-items">
                {menuItems.map((item) => {
                    ...
                    if(item.title === "Endodoncias"){
                        return(
                            <li key={item.id} className={item.cName} onMouseEnter={()=>setDropdownEndodoncia(true)} onMouseLeave={()=>setDropdownEndodoncia(false)}>
                        ...
                        return(
                            <li key={item.id} className={item.cName} onMouseEnter={()=>setDropdownPeriodoncia(true)} onMouseLeave={()=>setDropdownPeriodoncia(false)}>
                                <Link to={item.path}>{item.title}</Link>
                        ...
                        return(
                            <li key={item.id} className={item.cName} onMouseEnter={()=>setDropdownOdontopediatria(true)} onMouseLeave={()=>setDropdownOdontopediatria(false)}>
                                <Link to={item.path}>{item.title}</Link>
                        ...
                        return(
                            <li key={item.id} className={item.cName} onMouseEnter={()=>setDropdownOrtodoncia(true)} onMouseLeave={()=>setDropdownOrtodoncia(false)}>
                                <Link to={item.path}>{item.title}</Link>
                        ...
                        return(
                            <li key={item.id} className={item.cName} onMouseEnter={()=>setDropdownProtesis(true)} onMouseLeave={()=>setDropdownProtesis(false)}>
                                <Link to={item.path}>{item.title}</Link>
